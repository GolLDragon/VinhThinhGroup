...
public class LoaiSPCuaTB extends AppCompatActivity {
    Toolbar toolbar;
    ...
    LoaiSPCuaTB.mHandler mHandler;
    boolean limitdata = false;

    public static ArrayList<com.example.vinhthinhgroup.model.GioHang> manggiohang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loai_s_p_cua_t_b);
    ...
    private void GetMaLoai() {
        MaLoai = getIntent().getIntExtra("MaThietBi",-1);
        Log.d("giatri",MaLoai+"");
    }
        ...
        listViewloaisp.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView absListView, int FristItem, int VisibleItem, int TotalItem) {
                if(FristItem + VisibleItem == TotalItem && TotalItem != 0 && isLoading == false && limitdata == false){
                    isLoading = true;
                    Thread threadData = new LoaiSPCuaTB.ThreadData();
                    threadData.start();
                }
            }
        });
    ...
    private void GetData(int Page) {
        ...
        String duongdan = Server.DuongDanSPTheoTB+String.valueOf(Page);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongdan, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("MaThietBi",String.valueOf(MaLoai));
                return param;
            }
        };
    ...
    private void Anhxa() {
        toolbar = findViewById(R.id.toolbarloaispcuatb);
        listViewloaisp = findViewById(R.id.listviewloaispcuatb);
        mangloaisp = new ArrayList<>();
        loaispAdapter = new LoaiSPAdapter(getApplicationContext(),mangloaisp);
        listViewloaisp.setAdapter(loaispAdapter);
        LayoutInflater inflater = (LayoutInflater) getSystemService(LAYOUT_INFLATER_SERVICE);
        footerview = inflater.inflate(R.layout.progressbar,null);
        mHandler = new LoaiSPCuaTB.mHandler();
        if (manggiohang != null){
